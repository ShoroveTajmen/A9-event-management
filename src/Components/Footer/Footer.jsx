...
const Footer = () => {
  return (
    <div className="bg-blue-950 h-[500px]">
      ...
      <div className="grid grid-cols-6 ml-[150px] text-white pt-[100px] ">
        {/* 1st part */}
        <div className="col-span-2 w-[300px]">
          <h1 className="text-3xl font-bold mb-7">Tech/Cons</h1>
          <p>
        ...
        {/* 2nd part */}
        <div className="col-span-2 w-[300px]">
          <h1 className="text-3xl font-bold mb-7">Our Address</h1>
          <p>
            49 West 32nd Street, Dhaka, 4.9 mi / 7.9 km from Downtown, Bangladesh
          </p>
          <h1 className="mt-5">Monday — Friday: 8AM — 5PM</h1>
          <h1>Saturday: 10AM — 3PM</h1>
        </div>
        {/* 3rd part */}
        <div className="col-span-2 w-[300px]">
          <h1 className="text-3xl font-bold mb-7">Our Contact</h1>
