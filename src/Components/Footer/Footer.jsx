    ...
    <div className="bg-blue-950 h-[900px] md:h-[600px] lg:h-[500px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-6 ml-[90px] md:ml-[40px] lg:ml-[150px] text-white pt-[100px] ">
        ...
        <div className="col-span-2 w-[300px] md:w-[200px] lg:w-[300px]">
          <h1 className="text-3xl font-bold mb-3 md:mb-7 text-blue-700">Tech/Cons</h1>
        ...
        {/* 2nd part */}
        <div className="col-span-2 w-[300px] md:w-[200px] lg:w-[300px]">
          <h1 className="text-3xl font-bold mb-3 md:mb-7 text-blue-700">Our Address</h1>
          <p >
        ...
        {/* 3rd part */}
        <div className="col-span-2 w-[300px] md:w-[200px] lg:w-[300px]">
          <h1 className="text-3xl font-bold mb-3 md:mb-7 text-blue-700">Our Contact</h1>
