    ...
    <div>
      <div className="relative w-full h-[400px]">
        ...
        <div className="relative">
            <h1 className="absolute text-white top-[160px] md:top-[150px] md:left-[150px] lg:left-[550px] left-[40px] font-bold text-4xl md:text-5xl text-center">VENUE OF THE EVENT</h1>
            <h1 className="text-white absolute top-[230px] md:top-[210px] md:left-[290px] lg:left-[690px] left-[115px]">InnovateSpace Event Arena</h1>
        </div>
      </div>
