...
const EventVenue = ({ serviceCard }) => {
    ...
    serviceCard || {};
    return (
        <div className="h-[900px] flex flex-col md:flex-row justify-center items-center md:w-[1400px] w-[370px] mx-auto gap-12 mb-[1px]">
            <div>
                <img className="w-[350px] h-[350px] md:w-[550px] md:h-[550px] rounded-3xl mt-12 md:mt-0" src={venuePic} alt="" />
            </div>
